...
export class EmployeePage {
  ...
  async fillStep1(data: any) {
    ...
    // ===============================
    // TEST CUSTOM FIELDS (Ditambah jeda 500ms meniru kecepatan manual)
    // ===============================
    ...
    // ===============================
    // START DATE & END DATE (Kembali murni ke Codegen Manual)
    // ===============================
    ...
    await this.page.waitForTimeout(500); // Beri waktu agar sistem membaca inputnya
    ...
    await this.page.waitForTimeout(500); // Jeda setelah save agar dropdown Taxability tidak terblokir
